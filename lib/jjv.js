...
(function () {
  ...
  var checkValidity = function (env, schema_name, schema, object, name, required, options) {
    ...
    if (object.hasOwnProperty(name)) {
      ...
      for (v in schema) {
        if (schema.hasOwnProperty(v) && v !== 'properties' && v !== 'items' && v !== 'type' && v !== 'required' && v !== 'default' && v !== 'title' && v !== 'description' && v !== 'definitions' && v !== '$ref' && v !== '$schema') {
          if (v === 'format') {
  ...
  var checkExtra = function (schema, object, name, prefix, options) {
    var extraFields = [], subfields, p, i, j, len, len2;
    ...
    if (typeof schema !== 'object') {
      ...
      for (i = 0, len=object[name].length; i<len; i++)  {
        ...
        for (j = 0, len2=subfields.length; j<len2; j++)
          extraFields.push(subfields[j]);
      }
    }
