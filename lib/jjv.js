...
(function () {
  ...
  var checkValidity = function (env, schema_stack, object_stack, options) {
    ...
    var i, len, count, orig_object = {}, hasProp, hasPattern;

    var schema = schema_stack[schema_stack.length-1], object = object_stack[object_stack.length-1].object, name = object_stack[object_stack.length-1].key, prop = object[name];
